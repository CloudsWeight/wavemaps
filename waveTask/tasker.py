...
class TwilioKey:
    # these are self explanatory when you sign up at TWILIO.COM
    def __init__(self):
        self.account_sid_key = "SIGN UP AT TWILIO.COM"
        self.auth_token_key = "SIGN UP AT TWILIO.COM"
...
def send_text(height, period):
    ...
    # create a custom text message, just leave height and period
...
class BuoyData:
    ''' Initializes to buoy#46224.  To change #, set_buoy_n(#).  
        To save the url, set_buoy_url() '''
...
'''
Some other random working buoy numbers because not all buoy numbers work:
